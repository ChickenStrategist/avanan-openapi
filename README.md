# Check Point Harmony Email & Collaboration (Avanan) API - Curated

Official OpenAPI 3.0 specification for Avanan API integration with Rewst.
...
- **Version**: v1.0-curated
- **Base URL**: `https://cloudinfra-gw-us.portal.checkpoint.com/app/hec-api/v1.0`
- **Authentication**: BearerAuth

## Description
Practical subset for MSP automation: auth, security events (get/query), and exceptions (whitelist). Requires x-av-req-id and Bearer access token.
